...
async def consumer_task() -> None:
    ...
    VAD_SPEECH_ON      = 0.50  # enter speech when prob >= this
    VAD_SPEECH_OFF     = 0.30  # exit speech when prob <= this
    ...
    PRE_ROLL_SEC       = 0.20  # prepend a little pre-speech audio
    # --------------------------------------------------------------
...
async def main():
    ...
    silero_model, utils = torch.hub.load(
        repo_or_dir="../silero-vad-master", model="silero_vad", source="local", force_reload=False
    )
