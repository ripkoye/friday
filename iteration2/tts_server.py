...
class TTSServer:
            ...
            while True:
                ...
                if message['type'] == 'message':
                    try:
                        ...
                        # Generate audio and send to client
                        await self.generate_and_send_audio(text)
    ...
    async def generate_and_send_audio(self, text):
    ...
    async def send_audio_to_client(self, audio_data):
        ...
        if self.client_writer:
            ...
            print("[TTSServer] No client connected, cannot send audio")
